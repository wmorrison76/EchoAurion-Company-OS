...
export const config = {
  ...
  matcher: [
    '/((?!login|api/auth|api/health|api/financial/webhook|api/financial/sync|api/support/diagnostics|api/relay|_next/static|_next/image|favicon.ico|manifest.webmanifest|sw.js|icon-|apple-touch-icon).*)',
  ],
}
